    ...
    <div id="sidebar-scrollbar">
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu">
                ...
                <li class="active">
                    <a href="{{route('admin.category.index')}}" class="iq-waves-effect"><i class="ri-hospital-fill"></i><span>Category</span></a>
                </li>
                <li>
                    <a href="{{route('admin.menu.index')}}" class="iq-waves-effect"><i class="ri-home-8-fill"></i><span>Menu </span></a>
                </li>
                <li>
                    <a href="{{route('admin.user.index')}}" class="iq-waves-effect"><i class="ri-briefcase-4-fill"></i><span>User</span></a>
                </li>
                <li>
                    <a href="#" class="iq-waves-effect"><i class="ri-group-fill"></i><span>SeO</span></a>
                </li>
                <li>
                    <a href="{{route('admin.comment.index')}}" class="iq-waves-effect"><i class="lab la-mendeley"></i><span>Comment</span><span class="badge badge-danger">New</span></a>
                </li>
